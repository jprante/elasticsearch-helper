...
public class DeleteReplicaShardResponse extends ActionResponse {
    ...
    public DeleteReplicaShardResponse() {
    }

    public DeleteReplicaShardResponse(ShardId shardId, int replicaLevel, long tookInMillis) {
