...
public class RiverExecuteResponse extends NodesOperationResponse implements ToXContent {

    private boolean[] executed;

    public RiverExecuteResponse() {
    }

    public RiverExecuteResponse setExecuted(boolean[] b) {
        this.executed = b;
        return this;
    }
