...
public class IngestCreateShardResponse extends ActionResponse {
    ...
    public IngestCreateShardResponse() {
        this.failure = Lists.newArrayList();
    }

    public IngestCreateShardResponse(ShardId shardId, int successSize, List<IngestItemFailure> failure) {
