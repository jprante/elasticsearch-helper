 ...
 */
public class IngestIndexRequestBuilder extends ActionRequestBuilder<IngestIndexRequest, IngestResponse, IngestIndexRequestBuilder> {

    public IngestIndexRequestBuilder(Client client) {
        super((InternalClient)client, new IngestIndexRequest());
    }
    ...
    protected void doExecute(ActionListener<IngestResponse> listener) {
        ((InternalClient)client).execute(IngestIndexAction.INSTANCE, request, listener);
    }
}
