...
public class IngestCreateRequest extends ActionRequest {
    ...
    public IngestCreateRequest setIndex(String index) {
    ...
    public IngestCreateRequest setType(String type) {
    ...
    public IngestCreateRequest add(Collection<IndexRequest> requests, long sizeInBytes) {
     ...
     */
    public IngestCreateRequest add(IndexRequest... requests) {
     ...
     * Adds a list of requests to be executed. Either index or delete requests.
     */
    public IngestCreateRequest add(Iterable<IndexRequest> requests) {
        for (IndexRequest request : requests) {
            add(request);
        }
        return this;
     ...
     */
    public IngestCreateRequest add(IndexRequest request) {
        request.beforeLocalFork();
        return internalAdd(request);
    }

    IngestCreateRequest internalAdd(IndexRequest request) {
     ...
     */
    public IngestCreateRequest consistencyLevel(WriteConsistencyLevel consistencyLevel) {
     ...
     */
    public IngestCreateRequest replicationType(ReplicationType replicationType) {
     ...
     */
    public IngestCreateRequest takeAll() {
     ...
     */
    public IngestCreateRequest take(int numRequests) {
        ...
        return new IngestCreateRequest().add(partRequest, size);
    }
