...
public class IngestCreateProcessor {
    ...
    public IngestCreateProcessor listener(Listener listener) {
        this.listener = listener;
        return this;
    }

    public IngestCreateProcessor listenerThreaded(boolean threaded) {
        ingestRequest.listenerThreaded(threaded);
        return this;
    }

    public IngestCreateProcessor replicationType(ReplicationType type) {
        ingestRequest.replicationType(type);
        return this;
    }

    public IngestCreateProcessor consistencyLevel(WriteConsistencyLevel level) {
     ...
     */
    private void process(final IngestCreateRequest request, final Listener listener) {
