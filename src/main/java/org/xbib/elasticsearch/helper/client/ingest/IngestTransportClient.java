...
public class IngestTransportClient extends BaseIngestTransportClient implements Ingest {
    ...
    @Override
    public IngestTransportClient init(Client client, IngestMetric metric) throws IOException {
    ...
    public IngestTransportClient init(Map<String,String> settings, IngestMetric metric) throws IOException {
        return this.init(ImmutableSettings.settingsBuilder().put(settings).build(), metric);
    }
