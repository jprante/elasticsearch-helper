...
public abstract class AbstractFeeder<T, R extends PipelineRequest, P extends Pipeline<T, R>>
    ...
    private List<AbstractFeeder> registry = new LinkedList();
    ...
    @Override
    public void newRequest(Pipeline<MeterMetric, MapPipelineElement> pipeline, MapPipelineElement request) {
        try {
    ...
    @Override
    public void error(Pipeline<MeterMetric, MapPipelineElement> pipeline, MapPipelineElement request, PipelineException error) {
