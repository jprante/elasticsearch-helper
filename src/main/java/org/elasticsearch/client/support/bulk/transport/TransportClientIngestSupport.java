 ...
 * under the License.
 */
package org.elasticsearch.client.support.bulk.transport;
...
public class TransportClientIngestSupport extends TransportClientSupport implements TransportClientIngest {
    ...
    /**
     * The default size of a bulk processor request
     */
    private int maxBulkActions = 100;
    /**
     * The default number of maximum concurrent bulk processor requests
     */
    private int maxConcurrentBulkRequests = 30;
    /**
     * The outstanding bulk processor requests
     */
     ...
     * The BulkProcessor
     */
    private BulkProcessor ingestProcessor;
    /**
     * The default index
     */
    ...
    public TransportClientIngestSupport newClient(URI uri) {
        ...
        BulkProcessor.Listener listener = new BulkProcessor.Listener() {
            ...
            public void afterBulk(long executionId, BulkRequest request, BulkResponse response) {
                ...
                logger.info("bulk [{}] [{} items] [{}] [{}ms]",
                        ...
                        response.hasFailures() ? "success" : "failed",
                        response.getTook().millis());
                if (!response.hasFailures()) {
                    logger.error("bulk [{}] [failure reason: {}]", executionId, response.buildFailureMessage());
                }
            }
        ...
        this.ingestProcessor = BulkProcessor.builder(client, listener)
    ...
    public TransportClientIngestSupport flush() {
        ...
        // we can't flush :( just wait 5s and hope it works
